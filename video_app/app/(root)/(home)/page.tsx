  ...
  return (
    <section className='flex size-full flex-col gap-10 text-white'>
      <div className='h-[400px] w-full rounded-[20px] mt-10  bg-slate-800 bg-cover flex flex-col relative' >
             <div className='absolute top-8 left-8 z-10 px-4 py-2 text-white flex flex-col'>
               <h2 className=' text-white bg-slate-700 w-72 h-12 text-center p-3 rounded-md'> Upcoming Meetings at 12.30 PM </h2>
