...
const Homepage = () => {
  ...
  return (
    <section className='flex size-full flex-col gap-10 text-white'>
      ...
      <div className='h-[300px] w-full rounded-[20px] mt-10  bg-slate-800 bg-cover flex flex-col relative' >
            ...
            <Image  src="/image/hero-background.png"  alt='bg'  height={500}  width={1800}  className=' max-md:hidden flex-1 rounded-[20px]' />
      </div>
